#!/usr/bin/env sh
# Generate ONLY multi-turn dataset, then Step 4 pseudo functions using OpenAI.
# Prerequisites: OPENAI_API_KEY set; will run Stage 1/2/3 if needed.
...
# Step 4: pseudo functions
# Set how many pseudo functions per sample
